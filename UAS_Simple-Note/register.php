                ...
                <div class="row w-100 mx-0">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <h4>Welcome To SiCatet!</h4>
                            <h6 class="fw-light">Register</h6>
                            <form class="pt-3" method="POST" action="proses-register.php">
                                ...
                                <div class="form-group">
                                    <input type="password" name="confirm_password" class="form-control form-control-lg" id="confirm_password" placeholder="Konfirmasi Password" required>
                                </div>
                                <div class="form-group">
